---
title: '下载和安装指引 - Circle 阅读模式'
date: 2021-03-13 09:43:15
tags: []
published: true
hideInList: false
feature: 
...
Circle 启用后在浏览器右上角显示一个灰色的圆圈图标（下图 2 处），即是 Circle 。部分浏览器（如最新版 Chrome 浏览器）会把所有扩展图标都折叠在了一处类似拼图的图标，你可以点击展开然后在圆圈图标右侧的图钉按钮（下图 1 处）移除到浏览器的右上角方便使用
