...
isTop: true
---
Circle 是网页阅读助手，可以把网页中的内容提取出来，重新整理渲染成更方便阅读的排版界面。目前已经上架 Chrome、Firfox、Microsoft Edge（最新版本正在审核） 和 360(最新版本正在审核) 扩展市场。[马上安装](https://ranhe.xyz/circle-install/)
...
![Circle 识别效果](https://ranhe.xyz/post-images/1625375586601.jpg)

舒适美观的界面、极易上手的操作、灵活丰富的配置、强大智能的识别算法共同成就了 Circle
...
你可以在浏览器使用本地文件，如markdown 文件和纯文本文件，Circle 也可以识别（需要开启“允许访问文件网址”）
